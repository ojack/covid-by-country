...
const timeSeries = (prop, casesByDate) => dates.map((date) => casesByDate[date] ? (casesByDate[date][prop] ? casesByDate[date][prop] : null): null)

// filling holes => [null, 1, 5, null, null, 8, 9, null] => [ 0, 1, 5, 6, 7, 8, 9, 9]
const fillHoles = (_series) => {
...
const arr = [null, null, 1, 5, null, null, undefined, 2, 9, null, null]

// const test = fillHoles(arr)
// console.log(test)
...
const countries = Object.entries(data).map(([key, obj]) => {
  ...
  countryObj['total_cases'] = fillHoles(timeSeries('total_cases', casesByDate))
  countryObj['total_cases_per_million'] = fillHoles(timeSeries('total_cases_per_million', casesByDate))
  countryObj['new_cases_per_million'] = fillHoles(timeSeries('new_cases_per_million', casesByDate))
...
const processed = JSON.stringify({ dates: dates, countries: countries}, null, 0)
...
//     //  convertDatesToArrays()
      fs.writeFileSync('./covid-cases-09-01.json', processed)
